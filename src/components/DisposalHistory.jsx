...
function DisposalHistorySection2({ filtered, items, setSelectedItem }) {
  return (
    <div
...
function DisposalHistorySection3({ setPage, totalPages, page, limit, total }) {
  return (
    totalPages > 1 && (
      <div
        style={{
...
function DisposalHistorySection4({ selectedItem, setSelectedItem }) {
  return (
    <AnimatePresence>
      {selectedItem && (
        <div

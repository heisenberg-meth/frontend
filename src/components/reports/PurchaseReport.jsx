  ...
  if (loading) {
    return (
      <div className="reports-loading" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "300px", gap: "12px" }}>
        ...
        <p style={{ color: "var(--text-muted)", fontSize: "14px" }}>Loading purchase intelligence data...</p>
      </div>
    );
  }
  ...
  if (errorState) {
    return (
      <div className="empty-state-card" style={{ padding: "40px", textAlign: "center", border: "1px solid rgba(220,53,69,0.2)", background: "rgba(220,53,69,0.05)", borderRadius: "8px" }}>
        ...
        <h4 style={{ fontWeight: 700, color: "var(--danger)" }}>Purchase Report Error</h4>
  ...
  if (!data || !data.supplierSpend.length) {
    return (
      <div className="empty-state-card" style={{ padding: "60px 20px", textAlign: "center" }}>
        ...
        <h4 style={{ fontWeight: 700 }}>No purchase data found</h4>
        <p style={{ color: "var(--text-muted)", marginTop: "6px" }}>There are no purchase transactions recorded in the selected period.</p>
      </div>
    );
  }
    ...
    <>
      ...
      <div className="report-charts-grid">
        <div className="pos-card">
          <div className="pos-card-title">Purchases Trend (last 4 active periods)</div>
          <div
            style={{
              height: "200px",
              marginTop: "32px",

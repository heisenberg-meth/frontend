...
function PnLReportSection1() {
  return <div className="pnl-summary-card">
        <div className="pnl-col-left">
          <div className="pnl-row">
            <span className="pnl-label">REVENUE</span>
            <span className="pnl-val" style={{
          color: "var(--primary)"
        }}>
        ...
        <div className="pnl-col-right" style={{
      display: "flex",
      ...
      alignItems: "center"
        ...
        height: "180px"
            ...
            <div className="donut-inner-text" style={{
          fontSize: "24px"
        }}>
              {summary.netMargin || 0}%
            </div>
...
export default function PnLReport({
  ...
  if (!data || !data.summary || typeof data.summary.revenue !== "number") {
    return <div className="empty-state-card" style={{
      ...
      textAlign: "center"
        ...
        <Briefcase size={40} color="var(--text-muted)" style={{
        marginBottom: "12px"
      }} />
        <h4 style={{
        fontWeight: 700
      }}>No financial data found</h4>
        <p style={{
        color: "var(--text-muted)",
        marginTop: "6px"
      }}>
  ...
  function renderExpenseModal() {
    return <div className="stock-modal-overlay" style={{
      zIndex: 1100
    }}>
        ...
        y: 20
          ...
          <div className="stock-modal-header">
            ...
            <button className="micro-btn" onClick={() => setShowExpenseModal(false)}>
              <X size={20} />
            </button>
          </div>
          ...
          textAlign: "left"
            ...
            gridTemplateColumns: "1fr"
              ...
              <div className="pos-input-group">
                ...
                <select id="field_79zo1g" className="pos-input" value={expenseCategory} onChange={e => setExpenseCategory(e.target.value)}>
              ...
              <div className="pos-input-group">
                ...
                <input id="field_hv99o8" required className="pos-input" type="number" placeholder="0.00" value={expenseAmount} onChange={e => setExpenseAmount(e.target.value)} />
              </div>
              <div className="pos-input-group">
                <label htmlFor="field_brtih5" className="p-label">
                  DESCRIPTION
                </label>
                <textarea id="field_brtih5" className="pos-input" style={{
                minHeight: "80px"
              }} placeholder="Notes about this expense..." value={expenseDescription} onChange={e => setExpenseDescription(e.target.value)} />
              </div>
              <div className="p-upload-zone" style={{
              padding: "12px",
              cursor: "pointer"
              ...
              if (file) {
                ...
                <input required type="file" hidden id="receiptUpload" onChange={e => {
                ...
                <label htmlFor="receiptUpload" style={{
                cursor: "pointer",
                display: "flex",
                flexDirection: "column",
                alignItems: "center"
              }}>
                  <UploadCloud size={20} style={{
                  color: "var(--primary)",
                  marginBottom: "4px"
                }} />
                  <div style={{
          ...
          <div className="stock-modal-footer">
            ...
            <button className="pos-btn teal" style={{
            flex: 2
          }} disabled={expenseSaving || !expenseAmount || !expenseCategory} onClick={async () => {
            if (!expenseCategory) {
  ...
  return <>
      ...
      marginTop: "24px"
        ...
        marginTop: "20px"
          ...
          {expensesDistribution.length === 0 ? <div className="result-meta" style={{
          textAlign: "center",
          padding: "40px 0",
          width: "100%"
        }}>
              No operational expenses logged for this range.
            </div> : expensesDistribution.map(c => <div key={c.name} className="expense-cat-card">

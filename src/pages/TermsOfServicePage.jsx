        ...
        <div className="legal-layout-container">
          ...
          <div className="legal-sidebar-wrapper">
            ...
            <div className="legal-search-container">
              ...
              <>
                <label htmlFor="field_4youyk" className="sr-only">
                  Search terms...
                </label>
                <input
                  type="text"
          ...
          <main ref={contentRef} className="legal-document-content">
            ...
            <p className="legal-hero-description">
              Review the terms, rules, and guidelines governing your use of the
              MedAssist platform.
            </p>
            ...
            <p>
              <strong>MedAssist</strong> means the pharmacy management software
              platform operated by the Company.
            </p>
            <p>
              <strong>Customer</strong> means the business or organization that
              purchases or subscribes to MedAssist.
            </p>
            <p>
              <strong>Authorized User</strong> means an employee, administrator,
              pharmacist, cashier, manager, or other individual authorized by
              the Customer to access the Services.
            </p>
            <p>
              <strong>Services</strong> means all software, applications, APIs,
              websites, and support services provided by MedAssist.
            </p>
            <p>
            ...
            <p>Available features depend on your selected subscription plan.</p>
            <p>
            ...
            <p>
              ...
              or other authorized payment providers.
            </p>
            <p>We do not store:</p>
            <ul>
            ...
            <p>
              All applicable taxes, including Goods and Services Tax (GST), will
              be charged in accordance with Indian law unless otherwise stated.
            </p>
            ...
            <ul>
              ...
              <li>
                We reserve the right to modify or discontinue free trials at any
                time.
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                Violate applicable pharmacy, healthcare, tax, or data protection
                laws.
              </li>
            </ul>
            ...
            <p>
              ...
              shall not exceed the subscription fees actually paid by you during
            ...
            <p>
              ...
              partners from any claims, damages, liabilities, costs, or expenses
              arising from:
            </p>
            <ul>
            ...
            <ul>
              ...
              <li>
                Notify users through the application or by email where required.
              </li>
            </ul>
            <p>

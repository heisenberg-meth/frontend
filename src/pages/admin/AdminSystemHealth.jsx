...
export default function AdminSystemHealth() {
  ...
  if (loading)
    return <div className="admin-loading-inline">Loading system health...</div>;
  if (!health)
  ...
  const statCards = [
    {
      label: "Tenants",
      value: health.counts.tenants,
      icon: ShoppingCart,
      color: "#3b82f6",
    },
    {
      label: "Users",
      value: health.counts.users,
      icon: Users,
      color: "#22c55e",
    },
    {
      label: "Subscriptions",
      value: health.counts.subscriptions,
      icon: CreditCard,
      color: "#8b5cf6",
    },
    {
      label: "Payments",
      value: health.counts.payments,
      icon: CreditCard,
      color: "#f59e0b",
    },
    {
      label: "Devices",
      value: health.counts.devices,
      icon: Monitor,
      color: "#6366f1",
    },
    {
      label: "Open Tickets",
      value: health.counts.openTickets,
      icon: Ticket,
      color: "#ef4444",
    },
  ];
    ...
    <div className="admin-page">
      ...
      >
        <div className="admin-stat-card">
          <div className="admin-stat-icon" style={{ color: "#3b82f6" }}>
            <Server size={24} />
          </div>
        ...
        <div className="admin-stat-card">
          <div
            ...
            style={{
              color:
                health.database.status === "healthy" ? "#22c55e" : "#ef4444",
            }}
          >
            <Database size={24} />
          </div>
          <div className="admin-stat-body">
            ...
            <span className="admin-stat-label">
              Database ({health.database.latency}ms)
            </span>
          </div>
        </div>
        <div className="admin-stat-card">
        ...
        <div className="admin-stat-card">
          <div className="admin-stat-icon" style={{ color: "#8b5cf6" }}>
            <HardDrive size={24} />
          </div>
          <div className="admin-stat-body">

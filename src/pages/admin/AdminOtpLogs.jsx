...
const STATUS_COLORS = {
  GENERATED: { bg: "#1e3a8a", text: "#93c5fd" },
  VERIFIED: { bg: "#14532d", text: "#86efac" },
  EXPIRED: { bg: "#422006", text: "#fde68a" },
  FAILED_INVALID_OTP: { bg: "#450a0a", text: "#fca5a5" },
  FAILED_MAX_ATTEMPTS: { bg: "#450a0a", text: "#fca5a5" },
};
  ...
  return (
    <div className="admin-page">
      <div className="admin-toolbar">
        <div className="admin-filter-group" style={{ flex: 1, maxWidth: 300 }}>
          <Search size={16} />
          <input
            type="text"

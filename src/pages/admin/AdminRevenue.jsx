...
import { TrendingUp, TrendingDown, DollarSign, CreditCard, BarChart3, RefreshCw, Users, Activity } from "lucide-react";
...
export default function AdminRevenue() {
  ...
  const fetchRevenueData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const [overviewRes, monthlyRes] = await Promise.all([adminApi.getRevenueOverview(), adminApi.getMonthlyRevenue(12)]);
  ...
  return <div className="admin-page">
      <div className="admin-dashboard-stats">
        ...
        return <div key={card.label} className="admin-stat-card">
      ...
      <div className="admin-dashboard-section">
        ...
        gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))"
          ...
          const Icon = card.icon;
          return <div key={card.label} className="admin-stat-card" style={{
            padding: "12px 16px"
          }}>
                <div className="admin-stat-icon" style={{
              color: card.color
                ...
                <div className="admin-stat-body">
                  <span className="admin-stat-value" style={{
                fontSize: 18
              }}>
                    {card.value}
                  </span>
      ...
      {monthly.length > 0 && <div className="admin-dashboard-section">
          <h3>
            <BarChart3 size={16} /> Monthly Revenue (12 months)
          </h3>
          <div className="admin-chart">
            {monthly.map(m => <div key={m.month} className="admin-chart-bar-group">

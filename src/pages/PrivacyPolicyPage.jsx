        ...
        <div className="legal-layout-container">
          ...
          <div className="legal-sidebar-wrapper">
            ...
            <div className="legal-search-container">
              ...
              <>
                <label htmlFor="field_4yns67" className="sr-only">
                  Search policy...
                </label>
                <input
                  type="text"
          ...
          <main ref={contentRef} className="legal-document-content">
            ...
            <p>
              This Privacy Policy applies to all users of MedAssist, including:
            </p>
            <ul>
            ...
            <p>
              This Privacy Policy also applies to all data collected through our
              desktop, mobile, web, and API services.
            </p>
            ...
            <p>
              ...
              maintain security, comply with legal obligations, and improve our
              platform.
            </p>
            ...
            <p>
              Additional services may be introduced in the future. This Privacy
            ...
            <ul>
              ...
              <li>
                MedAssist acts as the <strong>Data Processor</strong> on behalf
            ...
            <p>MedAssist is designed for businesses and professional users.</p>
            <p>
            ...
            <p>
              Certain information, including invoices, tax records, and legally
              required business records, may be retained for the period required
              by applicable laws.
            </p>
            <p>

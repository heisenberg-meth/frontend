...
import { Package, Receipt, BarChart2, ScanBarcode, Truck, CalendarClock, ArrowRight, Building2, Store, Pill, BoxesIcon, Hospital, Globe } from "lucide-react";
...
const PLANS = [{
  ...
  features: ["28 Days Free Access", "Full Platform Access", "Inventory Management", "Billing & POS", "Reports & Analytics", "Barcode & QR", "Email Support", "Up to 5 Users"]
}, {
  name: "Professional",
  price: "₹599",
  duration: "/month",
  ...
  features: ["Everything in Free Trial", "Up to 10 Users", "5 Branches", "50,000 Batch Records", "Excel & PDF Reports", "Premium Analytics", "Priority Support"]
}];
...
function AnimSection({
  ...
  return <div ref={ref} className={`lp-anim-section ${visible ? "lp-visible" : ""} ${className}`}>
      {children}
    </div>;
}
function CountUp({
  ...
  useEffect(() => {
    ...
    const t = setInterval(() => {
      ...
      if (cur >= num) {
        ...
        setVal(Math.floor(cur).toLocaleString("en-IN") + target.replace(/[0-9.,]/g, ""));
      }
    }, 18);
...
function LandingPageSection1({
  ...
  return <nav className={`lp-nav ${scrolled ? "lp-nav--scrolled" : ""}`}>
        ...
        behavior: "smooth"
          ...
          <div className={`lp-nav-links ${menuOpen ? "lp-nav-links--open" : ""}`}>
            ...
            {/* Download Dropdown */}
            <div className="lp-download-dropdown-wrapper" ref={downloadRef} onMouseEnter={() => setDownloadOpen(true)} onMouseLeave={() => setDownloadOpen(false)}>
              <button type="button" className={`lp-nav-link lp-download-btn ${downloadOpen ? "active" : ""}`}>
                Download <span className="lp-dropdown-arrow">▼</span>
              </button>

              {downloadOpen && <div className="lp-download-dropdown-menu">
                  <button type="button" className="lp-dropdown-item" onClick={() => setDownloadOpen(false)}>
          ...
          <div className="lp-nav-actions">
            <button className="lp-btn-ghost" id="nav-login-btn" onClick={() => navigate("/login")}>
              Log In
            </button>
            <button className="lp-btn-primary" id="nav-get-started-btn" onClick={() => navigate("/pricing")}>
...
function LandingPageSection2({
  ...
  return <section className="lp-hero" id="hero">
        ...
        <div className="lp-hero-content">
          ...
          <div className="lp-hero-cta">
            <button className="lp-btn-primary lp-btn-lg" id="hero-start-btn" onClick={() => navigate("/pricing")}>
              Start Free Trial <span className="lp-btn-arrow">→</span>
            </button>
            <button className="lp-btn-outline lp-btn-lg" id="hero-demo-btn" onClick={() => scrollTo("how-it-works")}>
              See How It Works
            </button>
          </div>
          <div className="lp-hero-trust">
            <div className="lp-trust-avatars">
              {["👨‍⚕️", "👩‍⚕️", "🧑‍⚕️", "👩‍💼"].map(e => <div key={e} className="lp-trust-avatar">
                  {e}
                </div>)}
            </div>
        ...
        <div className="lp-hero-mockup">
          <div className="lp-mockup-window">
            ...
            <div className="lp-mockup-body">
              ...
              Icon: CalendarClock,
              name: "clock"
            }].map((item, i) => <div key={item.name} className={`lp-mock-sidebar-item ${i === 0 ? "active" : ""}`}>
                    <item.Icon size={16} />
                  </div>)}
              </div>
              <div className="lp-mock-content">
                ...
                val: "7",
                trend: "🔔 Soon"
              }].map(s => <div key={s.label} className="lp-mock-stat-card">
                ...
                <div className="lp-mock-chart">
                  {[40, 65, 45, 80, 60, 90, 70, 85, 55, 75, 95, 68].map((h, i) => <div key={i} className="lp-mock-bar" style={{
                height: `${h}%`,
          ...
          <div className="lp-footer-top">
            ...
            behavior: "smooth"
              ...
              <p className="lp-footer-tagline">
                ...
                reports, and daily operations with one intelligent cloud
                platform.
              </p>
              <div className="lp-footer-socials">
                <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="lp-social-link">
                  in
                </a>
              </div>
            </div>
            <div className="lp-footer-links">
              <div className="lp-footer-col">
                ...
                <a href="#features" className="lp-footer-link" onClick={e => {
              e.preventDefault();
              scrollTo("features");
            }}>
                  Features
                </a>
                <a href="#pricing" className="lp-footer-link" onClick={e => {
              e.preventDefault();
              scrollTo("pricing");
            }}>
                  Pricing
                </a>
                <a href="#desktop-app" className="lp-footer-link" onClick={e => {
              e.preventDefault();
              scrollTo("desktop-app");
            }}>
                  Desktop App
                </a>
                <a href="#mobile-app" className="lp-footer-link" onClick={e => {
              e.preventDefault();
              scrollTo("mobile-app");
            }}>
                  Mobile App
                </a>
                <a href="#documentation" className="lp-footer-link" onClick={e => {
              e.preventDefault();
              ...
              <div className="lp-footer-col">
                ...
                <a href="https://www.viyaninfo.com/about" target="_blank" rel="noopener noreferrer" className="lp-footer-link">
                  About Us
                </a>
                <a href="https://www.viyaninfo.com/contact" target="_blank" rel="noopener noreferrer" className="lp-footer-link">
                  Contact
                </a>
              </div>
              <div className="lp-footer-col">
                <div className="lp-footer-col-title">Legal</div>
                <a href="/privacy-policy" className="lp-footer-link" onClick={e => {
              e.preventDefault();
              ...
              window.scrollTo(0, 0);
                ...
                <a href="/terms-of-service" className="lp-footer-link" onClick={e => {
              e.preventDefault();
              ...
              window.scrollTo(0, 0);
                ...
                <a href="/cookie-policy" className="lp-footer-link" onClick={e => {
              e.preventDefault();
...
export default function LandingPage() {
  ...
  return <div className="lp-root">
      {/* ── NAV ── */}
      <LandingPageSection1 e={e} scrollTo={scrollTo} setDownloadOpen={setDownloadOpen} navigate={navigate} setMenuOpen={setMenuOpen} menuOpen={menuOpen} />
      ...
      <section className="lp-stats-bar">
        <div className="lp-container">
          {STATS.map(s => <div key={s.label} className="lp-stat-item">
      ...
      <section className="lp-section" id="features">
        <div className="lp-container">
          ...
          <div className="lp-features-grid">
            {FEATURES.map((f, i) => <AnimSection key={f.title}>
      ...
      <section className="lp-section lp-pharma-types-section">
        <div className="lp-container">
          ...
          <div className="lp-pharma-types-grid">
            {PHARMACY_TYPES.map((pt, i) => <AnimSection key={pt.label}>
                <div className="lp-pharma-type-card" style={{
              "--pt-color": pt.color,
              animationDelay: `${i * 0.07}s`
            }}>
      ...
      <section className="lp-section lp-section--alt" id="how-it-works">
        <div className="lp-container">
          ...
          <div className="lp-steps">
            {STEPS.map((s, i) => <AnimSection key={s.num}>
      ...
      <section className="lp-section" id="pricing">
        <div className="lp-container">
          ...
          <div className="lp-plans">
            {PLANS.map(plan => <AnimSection key={plan.name}>
                <div className={`lp-plan-card ${plan.highlight ? "lp-plan-card--highlight" : ""}`}>
                  {plan.highlight && <div className="lp-plan-popular">Most Popular ⭐</div>}
                  ...
                  <ul className="lp-plan-features">
                    {plan.features.map((f, i) => <li key={`${plan.name}-feat-${i}`}>
                        <span className="lp-check">✓</span>
                        {f}
                      </li>)}
                  </ul>
                  <button className={plan.highlight ? "lp-btn-primary lp-btn-full" : "lp-btn-outline lp-btn-full"} id={`plan-${plan.name.toLowerCase()}-btn`} onClick={() => navigate("/pricing")}>
                    {plan.cta}
                  </button>
                </div>
              </AnimSection>)}
        ...
        <AnimSection>
          <div className="lp-cta-content">
            ...
            <div className="lp-cta-actions">
              <button className="lp-btn-primary lp-btn-lg" id="cta-start-btn" onClick={() => navigate("/pricing")}>
      ...
      {/* ── FOOTER ── */}
      <LandingPageSection3 e={e} scrollTo={scrollTo} navigate={navigate} />
    </div>;
}
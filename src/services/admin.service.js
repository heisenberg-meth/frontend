...
export const adminApi = {
  ...
  async getAdmins(params = {}) {
    const { data } = await adminHttp.get(API_ROUTES.ADMIN_ADMINS, {
      params,
    });
    return data;
  },
  ...
  async getDevices(params = {}) {
    const { data } = await adminHttp.get(API_ROUTES.ADMIN_DEVICES, {
      params,
    });
    return data;
  },
  ...
  async listShops(params = {}) {
    const { data } = await adminHttp.get("/admin/shops", {
      params,
    });
    return data;
  },
  ...
  async listSupportTickets(params = {}) {
    const { data } = await adminHttp.get("/admin/support-tickets", {
      params,
    });
    return data;
  },
  ...
  async listPayments(params = {}) {
    const { data } = await adminHttp.get("/admin/payments", {
      params,
    });
    return data;
  },
  ...
  async listSubscriptions(params = {}) {
    const { data } = await adminHttp.get("/admin/subscriptions", {
      params,
    });
    return data;
  },
  ...
  async listAllUsers(params = {}) {
    const { data } = await adminHttp.get("/admin/users/list-all", {
      params,
    });
    return data;
  },

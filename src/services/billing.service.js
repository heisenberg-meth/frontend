...
export const processSalesReturn = (data) => api.post("billing/returns", data);
export const getSalesCustomers = () => api.get("patients");
export const createSalesCustomer = (data) => api.post("patients", data);
export const getSalesCustomerById = (id) => api.get(`patients/${id}`);
export const updateSalesCustomer = (id, data) =>
  api.put(`patients/${id}`, data);
export const deleteSalesCustomer = (id) => api.delete(`patients/${id}`);
